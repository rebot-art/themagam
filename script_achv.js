...
(function () {
  ...
  const ACHV = [
    ...
    /* [2026-09-10] 스티커가 25 → 39 종이 되면서 목표도 같이 올립니다.
       ★ 여기를 안 고치면 25종만 써도 "모두 모았다" 가 됩니다. */
    { id: "stkall",  g: "표현", icon: "🖍", label: "스티커 수집가",  at: "cStkKind", n: 39,   new: true, desc: "서른아홉 종을 모두 한 번씩" },
    { id: "forest10",g: "표현", icon: "🎋", label: "대숲지기",      at: "cForest",  n: 10,   new: true, desc: "대숲에 10번" },
    /* ☕ 수다방 — **문을 닫은 방의 배지입니다** (2026-08-30, 콩).
       ---------------------------------------------------------------
       수다방을 접었으니 이 둘은 더 오르지 않습니다. 그런데도 **안
       지웁니다** — 이미 딴 분들의 배지가 사라지기 때문이에요. 딴 것을
       도로 뺏지 않는다는 이 방의 방침(펫을 걷을 때도 지킨 것)입니다.
       ★ 세는 자리(cChattyDay)도 그대로 둡니다. 지우면 이미 딴 사람의
         숫자까지 0 이 되어 배지가 꺼져요.
       ★ 되살릴 일이 생기면 git 기록에 script_chatty.js 가 있습니다. */
    { id: "chatty30", g: "표현", icon: "☕", label: "수다방 지킴이",   at: "cChattyDay", n: 30,  new: true,
      desc: "☕ 수다방에 들어온 날 통틀어 30일 (지금은 문을 닫은 방이에요)" },
    { id: "chatty100",g: "표현", icon: "🫖", label: "수다방 안방마님", at: "cChattyDay", n: 100, new: true,
      desc: "☕ 수다방에 들어온 날 통틀어 100일 (지금은 문을 닫은 방이에요)" },
