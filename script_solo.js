...
(function () {
  ...
  function 만들기() {
    ...
    /* 🚦 화면 공유 제한 (2026-09-21 — 콩)
       진짜 방과 같은 문턱을 심어 둡니다. 팝업을 보고 싶으면 이 방의
       **보이는 카드 수를 14장 이상**으로 올린 뒤 [🖥️ 화면 공유] 를
       눌러 보세요 — 유령도 접속 인원으로 세어집니다.
       ★ 방장 계정으로 보면 조용히 지나가서 팝업이 안 떠요 (그게 맞는 동작). */
    try { _설정("config/share", { on: true, max: 14, maxShare: 5 }); } catch (e) {}
