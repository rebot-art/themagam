...
function soloProfileBlockHtml(tgt) {
  ...
  <div class="solo-row">
    <div class="set-block solo-block">
      ...
      <!-- [2026-09-06 — 콩 "정사각형이면 어떤 느낌일지 궁금해" → 후속
           "닉네임 박스도 카드 너비에 맞춰 늘리고, 작업시간은 상태표
           위에 프사 옆으로, 프사는 원래 사이즈로"] 이 방에서만
           확인하는 실험용 스위치. -->
      ...
      <p class="hint" style="margin:2px 0 0;">
        가로를 지금 세로 길이만큼 넓혀요. 프사·상태표는 <b>원래 크기 그대로</b>
        두고, ⏱ 작업시간을 상태표 위로 옮겨 프사 옆에 나란히 세웁니다.
