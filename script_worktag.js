...
(function () {
  ...
  const TAGS = [
    ...
    /* 🚨 [2026-08-22 — 콩] 처음엔 방장 전용(방장만: true)이었습니다.
       [2026-08-30 — 콩] **모두에게 열었어요** — "비상 스티커는 모두가
       쓸 수 있어도 될 거 같아. 상태표 리페어가 있으니까!!"
       방장 전용 표시는 이제 🛠️REPAIR(상태표, script_profile.js 의
       CHOICES) 하나로 충분합니다. 마감이 터진 멤버라면 누구든 🚨 를
       붙일 수 있어야죠.
       ★ 되돌릴 땐 `방장만: true` 한 조각만 도로 붙이면 됩니다 —
         고르기 판을 거르는 고를수있나() 장치는 그대로 살아 있어요. */
    { v: "sos",    emoji: "🚨", label: "비상" }
  ];
